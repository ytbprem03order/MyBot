...
$url = "https://api.telegram.org/bot8182116911:AAHazy5ea1uvktMJQ8TIhO7-R5QMMwzoTDU/editMessageText?chat_id=".$chatId."&message_id=".$message_id."&text=".$message."&parse_mode=HTML";
file_get_contents($url);      
}
